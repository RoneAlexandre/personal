...
export const Benefits = () => (
    <section data-testid="benefits-section" className="py-24 sm:py-32 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
            ...
            <motion.div
                className="mt-14 grid grid-cols-2 lg:grid-cols-5 gap-px bg-neutral-800 border border-neutral-800"
                initial="hidden"
                whileInView="show"
                ...
                {BENEFITS.map((b) => {
                    ...
                    return (
                        <motion.div
                            ...
                            className="group bg-[#0A0A0A] hover:bg-[#141414] p-6 sm:p-8 transition-colors duration-300"
                        >
                            <Icon
                                size={36}
                                strokeWidth={1.5}
