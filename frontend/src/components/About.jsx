    ...
    <section id="sobre" data-testid="about-section" className="relative py-24 sm:py-32 bg-[#0A0A0A] grain">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 grid md:grid-cols-12 gap-12 md:gap-8 items-start">
            <div className="md:col-span-5 relative">
                <Reveal>
                    <div className="relative">
                        <div className="absolute -top-4 -left-4 w-full h-full border border-[#9C8674]/50" aria-hidden="true" />
                        <div className="relative overflow-hidden group">
                            ...
                            <div className="absolute bottom-4 left-4 flex items-center gap-2 text-cream/90 text-xs uppercase tracking-widest bg-black/60 backdrop-blur px-3 py-2 border border-neutral-700">
                                <MapPin size={12} className="text-terracota" /> Itapeva · São Paulo
                            </div>
                        </div>
                    </div>
                </Reveal>
            ...
            <div className="md:col-span-7 md:pl-6">
                    ...
                    {CHAPTERS.map((c, i) => (
                        <Reveal key={c.n} delay={0.1 + i * 0.1}>
                            <div className="grid grid-cols-[auto_1fr] gap-5 sm:gap-8 py-6 border-b border-neutral-800 group" data-testid={`about-chapter-${c.n}`}>
                                <span className="font-display text-3xl sm:text-4xl text-terracota/80 group-hover:text-terracota transition-colors duration-300">
                                    {c.n}
                                </span>
                                <div>
                                    <h3 className="font-display text-2xl sm:text-3xl uppercase tracking-wide text-cream mb-2">
                                        {c.title}
                                    </h3>
                ...
                <Reveal delay={0.35}>
                    <div className="mt-10 flex items-start gap-4 border border-[#9C8674] bg-[#9C8674]/[0.07] p-6" data-testid="athletes-highlight">
                        <Award size={32} strokeWidth={1.5} className="text-[#9C8674] shrink-0 mt-1" />
                        <div>
                            <h3 className="font-display text-2xl sm:text-3xl uppercase tracking-wide text-[#9C8674] mb-1">
                                Formação de Atletas
                            </h3>
